...
const adminMaintenanceController = __importStar(require("../controller/adminMaintenanceController"));
const jsonwebtoken_1 = require("../utils/jsonwebtoken");
const adminMaintenanceRouter = (0, express_1.Router)();
// Apply authentication and check for admin/super_admin roles
adminMaintenanceRouter.use(jsonwebtoken_1.authenticateJWT);
adminMaintenanceRouter.use((0, jsonwebtoken_1.authorizeRole)(["admin", "super_admin"]));
...
exports.default = adminMaintenanceRouter;
