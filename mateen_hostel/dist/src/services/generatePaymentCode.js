...
exports.generateCodeEmail = void 0;
const generateCodeEmail = (name, code) => {
          ...
          <div style="padding: 32px;">
            ...
            <div style="background: #f8f9ff; padding: 20px; border-radius: 8px; border-left: 4px solid #667eea; margin: 24px 0;">
              <p style="margin: 0; color: #555; font-size: 14px; line-height: 1.5;">
                ...
                If you have any questions about your ${code ? "access code" : "account balance"} or need assistance, 
...
exports.generateCodeEmail = generateCodeEmail;
