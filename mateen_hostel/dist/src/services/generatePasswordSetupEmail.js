...
exports.generatePasswordSetupEmail = void 0;
const generatePasswordSetupEmail = (email, tempPassword) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
exports.generatePasswordSetupEmail = generatePasswordSetupEmail;
