...
const defaultStyles = {
  dark: "https://tiles.openfreemap.org/styles/liberty", // OpenFreeMap default style
...
function DefaultLoader() {
  return (
    <div className="bg-oklch(1 0 0)/50 absolute inset-0 z-10 flex items-center justify-center backdrop-blur-xs dark:bg-oklch(0.141 0.005 285.823)/50">
      <div className="flex gap-1">
        <span className="bg-oklch(0.552 0.016 285.938)/60 size-1.5 animate-pulse rounded-full dark:bg-oklch(0.705 0.015 286.067)/60" />
        <span className="bg-oklch(0.552 0.016 285.938)/60 size-1.5 animate-pulse rounded-full [animation-delay:150ms] dark:bg-oklch(0.705 0.015 286.067)/60" />
        <span className="bg-oklch(0.552 0.016 285.938)/60 size-1.5 animate-pulse rounded-full [animation-delay:300ms] dark:bg-oklch(0.705 0.015 286.067)/60" />
      </div>
    </div>
  );
}
...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="focus-visible:ring-oklch(0.705 0.015 286.067) hover:bg-oklch(0.967 0.001 286.375) text-oklch(0.141 0.005 285.823) absolute top-0.5 right-0.5 z-10 inline-flex size-5 cursor-pointer items-center justify-center rounded-sm transition-colors focus:outline-none focus-visible:ring-2 dark:focus-visible:ring-oklch(0.552 0.016 285.938) dark:hover:bg-oklch(0.274 0.006 286.033) dark:text-oklch(0.985 0 0)"
    >
...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-oklch(1 0 0) text-oklch(0.141 0.005 285.823) relative max-w-62 rounded-md border border-oklch(0.92 0.004 286.32) p-3 shadow-md dark:bg-oklch(0.21 0.006 285.885) dark:text-oklch(0.985 0 0) dark:border-oklch(1 0 0 / 10%)",
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-oklch(0.141 0.005 285.823) text-oklch(1 0 0) pointer-events-none rounded-md px-2 py-1 text-xs text-balance shadow-md dark:bg-oklch(0.985 0 0) dark:text-oklch(0.141 0.005 285.823)",
        "animate-in fade-in-0 zoom-in-95 duration-200 ease-out",
        className,
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        "text-oklch(0.141 0.005 285.823) text-[10px] font-medium dark:text-oklch(0.985 0 0)",
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-oklch(0.92 0.004 286.32) bg-oklch(1 0 0) [&>button:not(:last-child)]:border-oklch(0.92 0.004 286.32) flex flex-col overflow-hidden rounded-md border shadow-sm [&>button:not(:last-child)]:border-b dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.141 0.005 285.823) dark:[&>button:not(:last-child)]:border-oklch(1 0 0 / 10%)">
      {children}
    </div>
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-oklch(0.967 0.001 286.375) dark:hover:bg-oklch(0.967 0.001 286.375)/40 dark:hover:bg-oklch(0.274 0.006 286.033) dark:dark:hover:bg-oklch(0.274 0.006 286.033)/40",
        "focus-visible:ring-oklch(0.705 0.015 286.067) focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset dark:focus-visible:ring-oklch(0.552 0.016 285.938)",
