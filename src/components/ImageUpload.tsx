        ...
        <div className="space-y-4">
            <div
                ...
                className={`
                    ...
                    ${images.length + existingImages.length >= 5 ? "opacity-50 cursor-not-allowed" : "cursor-pointer hover:border-primary"}
                `}
            >
                <input {...getInputProps()} disabled={images.length + existingImages.length >= 5} />
