        ...
        <div className="grid gap-8 md:grid-cols-3">
          {blogPosts.map((post, index) => (
            <motion.div
              ...
              className="overflow-hidden transition-shadow bg-card shadow-sm dark:bg-card rounded-xl hover:shadow-xl"
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-2 py-1 text-xs font-semibold text-white bg-primary rounded">{post.category}</span>
                </div>
              </div>
              <div className="p-6">
                ...
                <Link to={`/find-hostel`} className="inline-flex items-center font-medium text-primary hover:text-primary/80">
