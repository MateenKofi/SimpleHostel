        ...
        <div className="grid w-full place-items-center">
          <section id="about" className="container py-16 md:py-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              {/* Flexible Booking - Top Right (CTA Card) - Full width on mobile */}
              <div className="md:row-span-2 bg-gradient-to-br from-primary to-teal-green-600 rounded-2xl p-6 sm:p-8 flex flex-col justify-between text-white shadow-lg shadow-primary/20 md:min-h-[500px]">
                ...
                <button className="mt-6 bg-white hover:bg-white/90 text-primary font-semibold px-6 py-3 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 w-full sm:w-fit shadow-lg">
                  Start Free Trial
                  <span>→</span>
                </button>
              </div>

              {/* 100+ Verified Locations - Bottom (Spans 2 columns on desktop) */}
              <div className="lg:col-span-2 bg-card border border-border rounded-xl p-6 sm:p-8 shadow-sm hover:shadow-xl transition-all duration-300">
